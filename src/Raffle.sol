...
contract Raffle is VRFConsumerBaseV2 {
    ...
    /**
     * @dev this is the function the chainlink nodes will call to check if its time to perform upkeep
     * the following should be true to perform upkeep
     * 1.time has passed interval
     * 2.raffle is in an open state
